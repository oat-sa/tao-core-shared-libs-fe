...
if(a===d)return!0;setTimeout(function(){b(c,a)});return!1}}(),contents:[{id:"main",label:a.lang.sourcedialog.title,elements:[{type:"textarea",id:"data",dir:"ltr",inputStyle:"cursor:auto;width:100%;min-width:"+e+"px;max-width:unset;height:"+b+"px;tab-size:4;text-align:left;","class":"cke_source"}]}]}});